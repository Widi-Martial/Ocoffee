...
-- Création de la table cafe avec toutes les informations fusionnées
CREATE TABLE "cafe" (
    ...
    "reference" BIGINT,
    "origine" VARCHAR(100),
    "prix_au_kilo" DECIMAL(10, 2),
    "caracteristique_principale" VARCHAR(50),
    "disponible" BOOLEAN
);

-- Insertion des données dans la table cafe
INSERT INTO cafe ("nom", "description", "reference", "origine", "prix_au_kilo", "caracteristique_principale", "disponible") VALUES
